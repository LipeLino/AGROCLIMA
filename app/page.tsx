            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <FeatureCard
                  ...
                  description="Dados climáticos atualizados constantemente através de cinco estações meteorológicas estrategicamente posicionadas."
                />
                <FeatureCard
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg mb-6">
                  O projeto visa criar um sistema de vigilância agrometeorológica para Frutal-MG,
                  focando na obtenção de dados climáticos locais e sua disponibilização em plataformas online.
                </p>
                <p className="text-lg">
                  Utilizando tecnologia IoT e cinco estações meteorológicas, fornecemos dados precisos
                  e atualizados para auxiliar agricultores e profissionais na tomada de decisões.
                </p>
              </div>
            </div>
          </section>
